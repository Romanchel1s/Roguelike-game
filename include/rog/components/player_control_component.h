#ifndef INCLUDE_ROG_COMPONENTS_PLAYER_CONTROL_COMPONENT_H_
#define INCLUDE_ROG_COMPONENTS_PLAYER_CONTROL_COMPONENT_H_
...
#endif  // INCLUDE_ROG_COMPONENTS_PLAYER_CONTROL_COMPONENT_H_
