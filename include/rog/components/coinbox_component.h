#ifndef INCLUDE_ROG_COMPONENTS_COINBOX_COMPONENT_H_
#define INCLUDE_ROG_COMPONENTS_COINBOX_COMPONENT_H_
 ...
 */
class CoinBoxComponent : public IComponent {
  // Nothing to do, because it's a tag for systems
};

#endif  // INCLUDE_ROG_COMPONENTS_COINBOX_COMPONENT_H_
